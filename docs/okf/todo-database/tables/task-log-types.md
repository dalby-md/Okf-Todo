...
type: SQLite Table
title: TaskLogTypes
description: Defines stable types for automatic task history entries.
...
Defines stable types for automatic task history entries.
...
- `IX_TaskLogTypes_Code` on `Code`: unique.
